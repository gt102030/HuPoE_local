...
"}")
        ...
        self.label_title.setGeometry(QRect(0, 80, 661, 81))
        font = QFont()
        font.setFamily(u"Segoe UI")
        font.setPointSize(40)
        self.label_title.setFont(font)
        self.label_title.setStyleSheet(u"color: rgba(255, 107, 107, 255);")
...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<strong>HuPoE</strong> System", None))
        ...
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<strong>제작</strong>: 구태완, 변의혁", None))
    # retranslateUi
